...
* **2017-09-19:** After ~3 month preparation, [we](https://lightjason.github.io/about/) held the [multi-agent simulation workshop](http://lightjason.org/news/2017-09-workshop/) for the 2nd SocialCars cohort. My part was designing and realising the didactic concepts of the workshop.
...
* **2016-12-15:** Attended [EUMAS 2016, Valencia, 14th European Conference On Multi-Agent Systems](http://eumas-at2016.webs.upv.es) and [presented](http://lightjason.org/publications/2016-eumas-slides.pdf) paper [_LightJason: A BDI Framework Inspired by Jason_](http://lightjason.org/publications/2016-eumas.pdf).
* **2016-11-20:** Co-authored [technical report](http://lightjason.org/publications/2016-ifi-techreport.pdf) about [LightJason](http://lightjason.org), published in the [_IfI Technical Report Series_](http://www.in.tu-clausthal.de/forschung/technical-reports/).
* **2016-10-19:** Co-authored paper [_LightJason: A BDI Framework Inspired by Jason_](http://lightjason.org/publications/2016-eumas.pdf) (got accepted for publication at [EUMAS 2016](http://eumas-at2016.webs.upv.es)).
...
To answer my research questions regarding the suitability of different voting mechanisms for collective decision making in urban traffic, I developed the simulation tool [LightVoting](https://github.com/SocialCars/LightVoting) which is based on [LightJason](http://lightjason.org/) developed by my colleagues Philipp Kraus and Malte Aschermann.
